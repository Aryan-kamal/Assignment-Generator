...
const navItems = [
  ...
  { label: "AI Teacher's Toolkit", href: "#", icon: "file-text" },
  { label: "My Library", href: "#", icon: "clock" },
];
...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden lg:flex flex-col w-[220px] min-h-screen bg-[#f5f5f5] border-r border-gray-200 p-4">
      ...
      <Link
        href="#"
        className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-gray-600 hover:bg-white/60 mb-4"
      >
      ...
      <div className="flex items-center gap-3 bg-orange-50 rounded-xl p-3 border border-orange-100">
        ...
        <div>
          <p className="text-sm font-semibold text-gray-900">Dr. VSEC</p>
          <p className="text-xs text-gray-500">Awadhpuri, Kanpur</p>
        </div>
      </div>
    </aside>
  );
