...
const tabs = [
  ...
  { label: "AI Toolkit", href: "#", icon: "toolkit" },
];
...
export default function MobileNav() {
  ...
  return (
    <nav className="lg:hidden fixed bottom-0 left-0 right-0 bg-gray-900 rounded-t-2xl z-50">
      <div className="flex items-center justify-around py-2 px-2">
        {tabs.map((tab) => {
          const isActive = tab.href === "/assignments"
